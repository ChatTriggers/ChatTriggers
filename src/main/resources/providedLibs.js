...
var cameraPrevPitch = MinecraftVars.getPrevPlayerPitch();
var cameraYaw = MinecraftVars.getPlayerYaw();
var cameraPrevYaw = MinecraftVars.getPrevPlayerYaw();
...
function updateProvidedLibsTick() {
    ...
    cameraPrevPitch = MinecraftVars.getPrevPlayerPitch();
    cameraYaw = MinecraftVars.getPlayerYaw();
    cameraPrevYaw = MinecraftVars.getPrevPlayerYaw();

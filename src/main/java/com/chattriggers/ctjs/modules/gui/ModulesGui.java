...
public class ModulesGui extends GuiScreen {
    ...
    private class GuiModule {
        ...
        private void draw() {
            ...
            // background
           Renderer.drawRectangle(0x80000000, x, y, width, height);
            ...
            // line break
            Renderer.drawRectangle(0xa0000000, x + 2, y+12, width - 4, 2);
            ...
            for (int j = 0; j < descriptionLines.size(); j++) {
                Renderer.drawStringWithShadow(
                        Chat.addColor(descriptionLines.get(j)),
                        x + 2,
                        y + 20 + j * 10,
                        0xffffffff
                );

...
public class GuiIngameMixin {
    ...
    //$$ // @WrapWithCondition(
    //$$ //         method = "render",
    //$$ //         at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/hud/InGameHud;drawTextBackground(Lnet/minecraft/client/util/math/MatrixStack;Lnet/minecraft/client/font/TextRenderer;III)V"),
    //$$ //         slice = @Slice(from = @At(value = "INVOKE_STRING", target = "Lnet/minecraft/util/profiler/Profiler;push(Ljava/lang/String;)V", args = "ldc=titleAndSubtitle"))
    //$$ // )
    //$$ // private boolean chattriggers_renderTitleTrigger(InGameHud hud, MatrixStack matrix, TextRenderer renderer, int yOffset, int width, int color) {
    //$$ //     event = new CancellableEvent();
    //$$ //     if (this.title != null || this.subtitle != null) {
    //$$ //         TriggerType.RenderTitle.triggerAll(
    //$$ //                 NullableModifier.modify(this.title, Text::asString),
    //$$ //                 NullableModifier.modify(this.subtitle, Text::asString),
    //$$ //                 event
    //$$ //         );
    //$$ //     }
    //$$//
    ...
    //$$ //         slice = @Slice(from = @At(value = "INVOKE_STRING", target = "Lnet/minecraft/util/profiler/Profiler;push(Ljava/lang/String;)V", args = "ldc=titleAndSubtitle"))
    //$$ // )
    //$$ // private boolean chattriggers_renderTitleTrigger(TextRenderer renderer, MatrixStack matrices, Text text, float x, float y, int color) {
    //$$ //     return !event.isCanceled();
    //$$ // }
    //#endif
}
